...
\fi
 ...
 \appendixpage
  ...
  \IfFileExists{attachments.zip}{%
    ...
    This archive contains supplementary materials generated for this thesis build: source snapshot and analysis outputs.
    \par\smallskip
    \href{attachments.zip}{attachments.zip}%
  }{}
