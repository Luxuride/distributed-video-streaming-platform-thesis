...
\fi
 ...
 \appendixpage
  ...
  The following files are provided alongside the PDF.
  \begin{itemize}
    \item \IfFileExists{attachments/p2p-stream.zip}{\href{attachments/p2p-stream.zip}{p2p-stream.zip}}{p2p-stream.zip (not available in this build)}
    \item \IfFileExists{attachments/analysis.zip}{\href{attachments/analysis.zip}{analysis.zip}}{analysis.zip (not available in this build)}
    \item \IfFileExists{attachments/p2p-stream-linux.zip}{\href{attachments/p2p-stream-linux.zip}{p2p-stream-linux.zip}}{p2p-stream-linux.zip (pipeline artifact not available for this commit/build)}
    \item \IfFileExists{attachments/p2p-stream-linux-appimage.zip}{\href{attachments/p2p-stream-linux-appimage.zip}{p2p-stream-linux-appimage.zip}}{p2p-stream-linux-appimage.zip (pipeline artifact not available for this commit/build)}
  \end{itemize}
